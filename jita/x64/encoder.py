...
- There are no variable registers (``Rq(expr)``). ``gp64(n)`` and its
  siblings pick the register in Python before the instruction is encoded.
...
from ..core.patch import ABS64, REL8, REL32, SLOT_REL32, PatchKind
